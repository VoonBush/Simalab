                ...
                <div class="p-6 text-gray-900">
                    <form method="POST" action="{{ route('modul.store') }}">
                        ...
                        <div class="mb-4">
                            ...
                            <textarea id="deskripsi" name="deskripsi" class="border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm block mt-1 w-full" rows="4">{{ old('deskripsi') }}</textarea>
                            <x-input-error :messages="$errors->get('deskripsi')" class="mt-2" />
                        </div>

                        <div class="mb-4">
                            <x-input-label for="file_path" :value="__('Link URL Modul (Opsional, cth: link Google Drive)')" />
                            <x-text-input id="file_path" class="block mt-1 w-full" type="url" name="file_path" :value="old('file_path')" />
